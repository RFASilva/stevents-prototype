...
//				System.out.println(mapReader.getRowNumber());
				...
				// Obter informacao
				String codigo = (String) line.get("C�digo");
...
//					geom = convertCoords(longitud, latitude); //TODO: REMOVE COMMENT
				...
				String dataExtincao = (String) line.get("DataExtin��o");
				String horaExtincao = (String) line.get("HoraExtin��o");
				...
				double aa_espacoflorestal = Double.parseDouble((String) line.get("AA_Espa�oFlorestal (Pov+mato)"));
